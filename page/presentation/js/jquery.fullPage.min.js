...
!function (e, n) {
	"use strict";
	"function" == typeof define && define.amd ? define(["../../../../../Downloads/fullPage.js-master/fullPage.js-master/jquery.fullPage"], function (t) {
	...
	var a = "fullpage-wrapper", r = "." + a, l = "fp-scrollable", s = "." + l, c = "fp-responsive",
		...
		A = "#" + E, M = "fp-tooltip", O = "." + M, H = "fp-show-active", B = ".slide", R = "fp-slide", z = "." + R,
		D = z + v, P = "fp-slides", q = "." + P, F = "fp-slidesContainer", V = "." + F, W = "fp-table",
		Y = "fp-slidesNav", j = "." + Y, N = j + " a", U = "fp-controlArrow", X = "." + U, K = "fp-prev", Q = "." + K,
		G = U + " " + K, J = X + Q, Z = "fp-next", $ = "." + Z, _ = U + " " + Z, ee = X + $, ne = e(n), te = e(t),
		oe = {
			scrollbars: !0,
			mouseWheel: !0,
			hideScrollbars: !1,
	...
	e.fn.fullpage = function (l) {
		...
		function Oe() {
			...
			if (!l.autoScrolling || l.scrollBar) {
				var o = ne.scrollTop(), i = Be(o), a = 0, r = o + ne.height() / 2, s = lt.height() - ne.height() === o,
				...
				if (He(i) && (e(b).hasClass(g) || e(b).addClass(g).siblings().removeClass(g)), n = e(c).eq(a), !n.hasClass(p)) {
					At = !0;
					var u, h, v = e(b), m = v.index(y) + 1, w = Ln(n), S = n.data("anchor"), x = n.index(y) + 1,
						C = n.find(D);
		...
		function on() {
			if (!At && !l.lockAnchors) {
				var e = n.location.hash.replace("#", "").split("/"), t = decodeURIComponent(e[0]),
					o = decodeURIComponent(e[1]), i = "undefined" == typeof ct,
		...
		var ct, dt, ft, ut = !1,
			...
			pt = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, vt = e(this),
			gt = ne.height(), mt = !1, wt = !0, St = !0, yt = [], bt = {};
		...
		var At = !1, Mt = 0, Ot = 0, Ht = 0, Bt = 0, Rt = 0, zt = (new Date).getTime(), Dt = 0, Pt = 0, qt = gt
